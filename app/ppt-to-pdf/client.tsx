...
export default function PptToPdf() {
  ...
  const handleUpload = () => {
    ...
    xhr.open("POST", `${process.env.NEXT_PUBLIC_API_URL}/ppt-to-pdf/`);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-yellow-100 via-white to-orange-100 px-4">
      ...
      <div className="w-full max-w-lg bg-white shadow-2xl rounded-2xl p-8 border border-gray-100">
        ...
        <p className="text-center text-gray-500 mt-2 text-sm">
          Convert PowerPoint presentations into PDF instantly
        </p>
        ...
        {/* Upload Box */}
        <div className="mt-6 border-2 border-dashed border-yellow-300 rounded-xl p-6 text-center bg-yellow-50 hover:bg-yellow-100 transition">
