...
export default function WordToPpt() {
  ...
  const handleUpload = () => {
    if (!file) return alert("Please select a Word (.docx) file first!");
    ...
    xhr.open("POST", `${process.env.NEXT_PUBLIC_API_URL}/word-to-ppt/`);
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-100 via-white to-pink-100 px-4">
      ...
      <div className="w-full max-w-lg bg-white shadow-2xl rounded-2xl p-8 border border-gray-100">
        ...
        <p className="text-center text-gray-500 mt-2 text-sm">
          Convert Word documents into PowerPoint presentations
        </p>
        ...
        <div className="mt-6 border-2 border-dashed border-purple-300 rounded-xl p-6 text-center bg-purple-50 hover:bg-purple-100 transition">
